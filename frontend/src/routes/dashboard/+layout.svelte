							...
							{#if showUserMenu}
								<div class="absolute right-0 mt-1 w-48 bg-surface-700 border border-surface-600 rounded-lg shadow-lg overflow-hidden">
									...
									<div class="p-1">
										...
										<div class="border-t border-surface-600 my-1 md:hidden"></div>
										<a href="/docs" class="flex items-center gap-2 px-3 py-2 text-sm text-text-secondary hover:text-text-primary hover:bg-surface-600 rounded-md transition-colors md:hidden">
											<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
												<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
											</svg>
											Docs
										</a>
										<a href="https://discord.gg/RxP2z5NGtj" target="_blank" rel="noopener" class="flex items-center gap-2 px-3 py-2 text-sm text-text-secondary hover:text-text-primary hover:bg-surface-600 rounded-md transition-colors md:hidden">
											<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
